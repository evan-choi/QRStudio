...
using QRStudio.Engine.Properties;
...
namespace QRStudio.Engine.Codec
{
    public class QRCodeEncoder
    {
        private int[][] maxDataBitsArray =>
            new int[][] 
            {
                new int[] 
                {
                    ...
                    5352, 5712, 6256, 6880,
                    7312, 8000, 8496, 9024,
                    9544, 10136, 10984, 11640,
                    12328, 13048, 13800, 14496,
                ...
                new int[]
                {
                    ...
                    4712, 5176, 5768, 6360,
                    6888, 7456, 8048, 8752,
                    9392, 10208, 10960, 11744,
                    12248, 13048, 13880, 14744,
                    15640, 16568, 17528, 18448,
        ...
        virtual public ERROR_CORRECTION ErrorMode
		{
			get
			{
        ...
        virtual public ENCODE_MODE EncodeMode
		{
			get
			{
		...
		protected virtual bool[][] calQrcode(byte[] qrcodeData)
		{
			int dataLength;
			int dataCounter = 0;
        ...
        public virtual bool[][] Generate(string content, Encoding encoding = null)
        {
            return calQrcode((encoding ?? Encoding.Unicode).GetBytes(content));
        }
    }
}