...
namespace QRStudio.Control
{
    ...
    public class ColorBox : System.Windows.Controls.Control
    {
        ...
        public static RoutedCommand ImageFileSelect = new RoutedCommand();
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.CommandBindings.Add(new CommandBinding(ColorBox.ImageFileSelect, ImageFileSelect_Executed));
        }
        ...
        private void ImageFileSelect_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            var ofd = new OpenFileDialog()
            {
                Filter = "모든 이미지 파일|*.png;*.jpg;*.bmp"
            };
        ...
        public static readonly DependencyProperty ImageFileNameProperty =
            DependencyProperty.Register("ImageFileName", typeof(string), typeof(ColorBox), new PropertyMetadata(null, new PropertyChangedCallback(ImageFileNameChanged)));
        private static void ImageFileNameChanged(DependencyObject property, DependencyPropertyChangedEventArgs args)
        {
            ...
            img.UriSource = new Uri((string)args.NewValue);
            img.EndInit();

            cp.iBrush = new ImageBrush()
            {
                ImageSource = img,
        ...
        public IEnumerable<Enum> AvailableBrushTypes
        {
            get
            {
                BrushTypes temp = BrushTypes.None | BrushTypes.Solid | BrushTypes.Linear | BrushTypes.Radial | BrushTypes.Image;
                foreach (Enum value in Enum.GetValues(temp.GetType()))
                    if (temp.HasFlag(value))
                        yield return value;
            }
        ...
        private ImageBrush iBrush = null;
        public Brush Brush
        {
        ...
        public static readonly DependencyProperty BrushProperty =
            ...
            , new FrameworkPropertyMetadata(null, new PropertyChangedCallback(_BrushChanged)));
        static void _BrushChanged(DependencyObject property, DependencyPropertyChangedEventArgs args)
        {
            ColorBox c = property as ColorBox;         
            ...
            if (!c._BrushSetInternally)
            {
                ...
                c.RaiseBrushChangedEvent(c.Brush);
            }
        }        
        ...
        public static readonly RoutedEvent BrushChangedEvent =
            EventManager.RegisterRoutedEvent("BrushrChanged", RoutingStrategy.Bubble, typeof(BrushChangedEventHandler), typeof(ColorBox));
        ...
        {
            var newEventArgs = new BrushChangedEventArgs(BrushChangedEvent, brush);
            RaiseEvent(newEventArgs);
        }
